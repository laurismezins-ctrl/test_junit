...
import com.petProject.services.reqResService.ReqResServiceClient;
...
public class ReqResTest {
    ...
    public void testFirstTest() throws InterruptedException {
        ReqResServiceClient reqResServiceClient = new ReqResServiceClient();
...
//        not a real project without it someplace
        ...
        Response response = reqResServiceClient.getUser("/users/2");
